...
function SendMessage(message) {
    ...
    // 1. Official Thunkable Extension (2024–2025) – works perfectly on Android
    if (window.ThunkableWebviewerExtension && typeof window.ThunkableWebviewerExtension.postMessage === "function") {
        ...
        console.log("%c[Game → App] " + payload, "color: #4CAF50; font-weight: bold;");
        return;
    }

    // 2. Very old Thunkable (legacy)
    if (window.ThunkableWebviewer && typeof window.ThunkableWebviewer.postMessage === "function") {
        ...
        console.log("%c[Game → App] " + payload, "color: #4CAF50;");
        return;
    }
